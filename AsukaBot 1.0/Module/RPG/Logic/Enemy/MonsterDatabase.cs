    ...
    class MonsterDatabase
    {
        ...
        public MonsterDatabase()
        {
            if (Database == null)
            {
                ...
                Database.Add(new NormalEnemy("Goblin Mage", 12, 10, 23, 23, 5, 3, 5, 7, 10, EnemyType.Goblin));
                Database.Add(new NormalEnemy("Savage Goblin", 8, 5, 30, 30, 8, 3, 5, 4, 25, EnemyType.Goblin));
                Database.Add(new NormalEnemy("Goblin Ranger", 10, 8, 25, 25, 4, 3, 5, 4, 15, EnemyType.Goblin));
