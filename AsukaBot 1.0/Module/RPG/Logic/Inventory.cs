    ...
    public class Inventory
    {
        ...
        public void Setup()
        {
            if (AllItems == null)
            {
                ...
                AllItems.Add(new WeaponsItem("Iron Sword", "A sturdy iron sword, capable of infliction slashing damage.", 1, PhyDamgeType.Slash, MagicDamgeType.None, 1, true, 3, false, true, new List<ItemType>() { ItemType.Weapon, ItemType.Iron, ItemType.Slash }, new List<CraftingItemInItem>() { new CraftingItemInItem((CraftingItem)AllItems[GetItemByName("Iron")], 4) }, Rarity.common));
                AllItems.Add(new WeaponsItem("Iron Greatsword", "A sturdy iron greatsword, capable of inflicting slashing damage", 1, PhyDamgeType.Slash, MagicDamgeType.None, 5, true, 0, false, true, new List<ItemType>() { ItemType.Weapon, ItemType.Iron, ItemType.Slash }, new List<CraftingItemInItem>() { new CraftingItemInItem((CraftingItem)AllItems[GetItemByName("Iron")], 8) }, Rarity.common));
                AllItems.Add(new WeaponsItem("Iron Hammer", "A sturdy iron hammer, capable of infliction blunt damage.", 1, PhyDamgeType.Blunt, MagicDamgeType.None, 3, true, 0, false, true, new List<ItemType>() { ItemType.Iron, ItemType.Weapon, ItemType.Blunt }, new List<CraftingItemInItem> { new CraftingItemInItem((CraftingItem)AllItems[GetItemByName("Iron")], 4) }, Rarity.common));
                ...
                AllItems.Add(new WeaponsItem("Iron Axe", "A sturdy iron axe, capable of inflicting slashing damage.", 1, PhyDamgeType.Slash, MagicDamgeType.None, 4, true, 0, false, true, new List<ItemType>() { ItemType.Iron, ItemType.Weapon, ItemType.Slash }, new List<CraftingItemInItem> { new CraftingItemInItem((CraftingItem)AllItems[GetItemByName("Iron")], 2) }, Rarity.common));
                AllItems.Add(new WeaponsItem("Iron Battleaxe", "A sturdy iron battleaxe, capable of inflicting slashing damage.", 6, PhyDamgeType.Slash, MagicDamgeType.None, 1, true, 0, false, true, new List<ItemType>() { ItemType.Weapon, ItemType.Iron, ItemType.Slash }, new List<CraftingItemInItem> { new CraftingItemInItem((CraftingItem)AllItems[GetItemByName("Iron")], 4) }, Rarity.common));
                AllItems.Add(new WeaponsItem("Iron Dagger", "A sturdy iron dagger, capable of inflicting puncturing damage.", 2, PhyDamgeType.Punture, MagicDamgeType.None, 1, true, 0, false, true, new List<ItemType>() { ItemType.Weapon, ItemType.Iron, ItemType.Punture }, new List<CraftingItemInItem> { new CraftingItemInItem((CraftingItem)AllItems[GetItemByName("Iron")], 2) }, Rarity.common));
                #endregion
                #endregion
