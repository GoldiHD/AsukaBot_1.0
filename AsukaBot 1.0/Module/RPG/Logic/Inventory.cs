    ...
    public class Inventory
    {
        ...
        public void Setup()
        {
            if (AllItems == null)
            {
                ...
                AllItems.Add(new WeaponsItem("Wooden Sword", "A wooden sword! It might look harmless, but a slap from this baby does sting quite a bit!", 1, PhyDamgeType.Blunt, MagicDamgeType.None, 1, true, 0, false, true, new List<ItemType>() { ItemType.Wood, ItemType.Weapon, ItemType.Blunt }, new List<CraftingItemInItem>() { new CraftingItemInItem((CraftingItem)AllItems[GetItemByName("Regular wood")], 4) }, Rarity.common));
                AllItems.Add(new WeaponsItem("Dragon tooth spear", "A mighty spear made of a dragon tooth strapped onto some elderwood", 1, PhyDamgeType.Punture, MagicDamgeType.None, 1, false, 0, false, true, new List<ItemType>() { ItemType.Dragon, ItemType.Punture, ItemType.Weapon }, new List<CraftingItemInItem>() { new CraftingItemInItem((CraftingItem)AllItems[GetItemByName("Dragon tooth")], 2), new CraftingItemInItem((CraftingItem)AllItems[GetItemByName("Regular wood")], 4) }, Rarity.legendary));
                AllItems.Add(new WeaponsItem("God slayers hammer", "a hammer made for slaying even gods", 250, PhyDamgeType.Blunt, MagicDamgeType.None, 1000000, false, 0, false, false, new List<ItemType>() { ItemType.Blunt, ItemType.Weapon }, new List<CraftingItemInItem>(), Rarity.mythicc));
                #region Iron Tier
                ...
                AllItems.Add(new WeaponsItem("Iron Sword", "A sturdy iron sword, capable of infliction slashing damage.", 1, PhyDamgeType.Slash, MagicDamgeType.None, 1, true, 1, false, true, new List<ItemType>() { ItemType.Weapon, ItemType.Iron, ItemType.Slash }, new List<CraftingItemInItem>() { new CraftingItemInItem((CraftingItem)AllItems[GetItemByName("Iron")], 4) }, Rarity.common));
                AllItems.Add(new WeaponsItem("Iron Greatsword", "A sturdy iron greatsword, capable of inflicting slashing damage", 1, PhyDamgeType.Slash, MagicDamgeType.None, 1, true, 0, false, true, new List<ItemType>() { ItemType.Weapon, ItemType.Iron, ItemType.Slash }, new List<CraftingItemInItem>() { new CraftingItemInItem((CraftingItem)AllItems[GetItemByName("Iron")], 8) }, Rarity.common));
                AllItems.Add(new WeaponsItem("Iron Hammer", "A sturdy iron hammer, capable of infliction blunt damage.", 1, PhyDamgeType.Blunt, MagicDamgeType.None, 1, true, 0, false, true, new List<ItemType>() { ItemType.Iron, ItemType.Weapon, ItemType.Blunt }, new List<CraftingItemInItem> { new CraftingItemInItem((CraftingItem)AllItems[GetItemByName("Iron")], 4) }, Rarity.common));
                AllItems.Add(new WeaponsItem("Iron Warhammer", "A sturdy iron warhammer, capable of inflicting blunt damage.", 1, PhyDamgeType.Blunt, MagicDamgeType.None, 1, true, 0, false, true, new List<ItemType>() { ItemType.Iron, ItemType.Weapon, ItemType.Blunt }, new List<CraftingItemInItem> { new CraftingItemInItem((CraftingItem)AllItems[GetItemByName("Iron")], 8) }, Rarity.common));
                AllItems.Add(new WeaponsItem("Iron Axe", "A sturdy iron axe, capable of inflicting slashing damage.", 1, PhyDamgeType.Slash, MagicDamgeType.None, 1, true, 0, false, true, new List<ItemType>() { ItemType.Iron, ItemType.Weapon, ItemType.Slash }, new List<CraftingItemInItem> { new CraftingItemInItem((CraftingItem)AllItems[GetItemByName("Iron")], 2) }, Rarity.common));
                AllItems.Add(new WeaponsItem("Iron Battleaxe", "A sturdy iron battleaxe, capable of inflicting slashing damage.", 1, PhyDamgeType.Slash, MagicDamgeType.None, 1, true, 0, false, true, new List<ItemType>() { ItemType.Weapon, ItemType.Iron, ItemType.Slash }, new List<CraftingItemInItem> { new CraftingItemInItem((CraftingItem)AllItems[GetItemByName("Iron")], 4) }, Rarity.common));
                AllItems.Add(new WeaponsItem("Iron Dagger", "A sturdy iron dagger, capable of inflicting puncturing damage.", 1, PhyDamgeType.Punture, MagicDamgeType.None, 1, true, 0, false, true, new List<ItemType>() { ItemType.Weapon, ItemType.Iron, ItemType.Punture }, new List<CraftingItemInItem> { new CraftingItemInItem((CraftingItem)AllItems[GetItemByName("Iron")], 2) }, Rarity.common));
                #endregion
                #endregion
